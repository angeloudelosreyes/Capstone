<form action="{{ route('folder.shareable.update') }}" method="POST">
    @csrf
    @honeypot
    <input type="hidden" name="old" id="old3">
    <input type="hidden" name="id" id="id3">
    <div class="modal fade component" id="update_shareablefolder" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
