                                                    ...
                                                    @if (Route::has('account.update'))
                                                        <li>
                                                            <a href="javascript:void(0)"
                                                                onclick="account_update('{{ Crypt::encryptString($data->id) }}','{{ $data->name }}','{{ $data->department }}','{{ $data->email }}','{{ $data->address }}','{{ $data->age }}')"
                                                                class="dropdown-item">
                                                        ...
                                                        <li>
                                                            <a href="{{ route('account.destroy', ['id' => Crypt::encryptString($data->id)]) }}"
                                                                class="dropdown-item">
                                                                <i
                                                                    class="bx bx-trash align-bottom me-2 text-muted"></i>Delete
                                                            </a>
                                                        </li>
                                                    @endif
                                                </ul>
